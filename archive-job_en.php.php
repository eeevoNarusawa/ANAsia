<?php
/*
Template Name: English Job list
*/
?>
<?php get_header(); ?>
    ...
    <div class="p-job-wrap">
      <div class="p-job-conts">
        ...
        $args =	array(
      		...
      		'post_type'        => 'job_en', //投稿タイプ名postは通常の投稿
      ...
      <div class="p-job-sidebar">
        <div class="p-job-sidebar--cat">
          ...
          <ul class="p-job-sidebar--list">
            <?php
              $terms = get_terms( 'jobtype_en');
              foreach ( $terms as $term ){
              echo '<a href="'.get_term_link($term->slug, 'jobtype_en').'"><li>'.$term->name.'</li></a>';
              }
            ?>
          </ul>
        </div>
